...
const translations = {
  ...
  de: {
    ...
    'proj5.subtitle': 'Kameragesteuterter Roboter, der Grids navigiert, Spuren erkennt und Sokoban-Puzzles in ROS 2 löst',
    'proj5.p1': 'Kamerabasiertes Navigationssystem für einen TurtleBot3 in ROS 2 Humble gebaut — fusioniert Sensordaten und steuert die Geschwindigkeit in Echtzeit.',
    'proj5.p2': 'OpenCV-Modul für Spurerkennung und Bildverarbeitung geschrieben, damit der Roboter in der Spur bleibt.',
    ...
    'proj6.subtitle': 'Drei Mini-Projekte: RL-Autobahnfahren, LiDAR-Sensorfusion und adaptiver Tempomat',
