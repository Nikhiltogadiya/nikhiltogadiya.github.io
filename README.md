...
I'm an AI/ML Engineer doing my M.Sc. in Digital Technology at **Ostfalia Hochschule**, Germany. Most of my work sits at the intersection of multi-agent systems, LLM fine-tuning, and getting ML pipelines into production.

Some things I've built so far:

- 🤖 **Multi-agent AI museum guide** on Temi robots with RAG-based retrieval (WOBCOM)
- 🚗 **Constrained LLM fine-tuning** for automated test generation (Volkswagen AG)
- 🏭 **Text2CAD** pipeline that turns plain text into manufacturable 3D CAD models using a multi-agent system
- 📊 **ML-based ticket sales forecasting** for a professional ice hockey team
- 🤖 **ROS 2 robotics projects** with camera-based navigation and Sokoban puzzle solving
- 🚙 **Autonomous driving** mini-projects: deep reinforcement learning, sensor fusion, adaptive cruise control

I like taking ideas from research papers and making them actually work. If it's running in production, even better.
...
![XGBoost](https://img.shields.io/badge/XGBoost-1B72BE?style=flat-square&logoColor=white)
![Deep RL](https://img.shields.io/badge/Deep_RL-7B48C1?style=flat-square&logoColor=white)
![PPO](https://img.shields.io/badge/PPO-9333EA?style=flat-square&logoColor=white)
...
![Constrained Decoding](https://img.shields.io/badge/Constrained_Decoding-E34F26?style=flat-square&logoColor=white)
![Vision-Language Models](https://img.shields.io/badge/VLMs-06B6D4?style=flat-square&logoColor=white)

**Agentic AI & RAG**

![LangChain](https://img.shields.io/badge/LangChain-2D6B4D?style=flat-square&logo=langchain&logoColor=white)
![LangGraph](https://img.shields.io/badge/LangGraph-3B82F6?style=flat-square&logoColor=white)
![CrewAI](https://img.shields.io/badge/CrewAI-F59E0B?style=flat-square&logoColor=white)
...
![Webots](https://img.shields.io/badge/Webots-A42E2B?style=flat-square&logoColor=white)
![Sensor Fusion](https://img.shields.io/badge/Sensor_Fusion-10B981?style=flat-square&logoColor=white)
